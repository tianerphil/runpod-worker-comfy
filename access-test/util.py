...
def post_request(payload):
    ...
    # Print the POST message prepared
    print("Preparing to send POST request with the following details:")
    print("URL:", f'{base_url}/runsync')
    print("Headers:", f'Bearer {runpod_api_key}')
